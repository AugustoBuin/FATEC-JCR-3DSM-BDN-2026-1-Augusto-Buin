# TurboFlow Agents Guide

## Agents

| Agent | Purpose | When to Use |
|-------|---------|-------------|
| `feature-architect` | Complete feature implementation — tests (RED first), types, API hooks, components | Building any new feature end-to-end |
| `quality-auditor` | Codebase audit for quality, performance, correctness, and convention compliance | Before pushes and PRs (auto-triggered), before releases, weekly health checks |
...
- `padroes-dev-turbo.md` (project root) — naming, branching, story points, clean code conventions
- `CLAUDE.md` (project root) — architecture rules, tech stack, path aliases
